...
static GKModule __unlock_weapons = { "Weapon Unlock", EXPLOIT, 0x0, ImGuiKey_None, false, { (GKSetting<int>*)&__weapon_list, (GKSetting<int>*)&__unlock_weapons_dev, (GKSetting<int>*)&__unlock_weapons_all } };
